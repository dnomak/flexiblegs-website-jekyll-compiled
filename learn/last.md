...
<div id="css">
  <div class="dn-browser">
    <div class="dn-browser-header">
      ...
      <div class="dn-style--title">col(align(<span>last</span>)) (css)</div>
    ...
    <div class="dn-browser-body">
      <div class="dn-browser-body__pre">
        ...
        <pre class="is-compiled"><div class="dn-tag dn-tag--black dn-tag--top dn-tag--button">close</div><!--
          --><span>wrap > col(align(last))</span><br/><!--
          -->  order: 1;<br/><!--
        --></pre>
      </div>
      <div class="dn-browser-body__item">
        ...
        <div class="wrap xl-flexbox xl-gutter-24 xl-3 dn-style--wrap">
          <div class="col xl-last"><div class="dn-style--col">01</div></div>
      ...
      <div class="dn-browser-footer">
        <div class="wrap xl-gutter-24 xl-outside-24 xl-center xl-auto">
          <div class="col">
            <a href="http://codepen.io/dnomak/pen/VLgrLN?editors=110" class="dn-button dn-button--link">
              http://codepen.io/dnomak/pen/VLgrLN
            </a>
          </div>
        </div>
      </div>
