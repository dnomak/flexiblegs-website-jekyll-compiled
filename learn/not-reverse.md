    ...
    <div class="dn-browser-body">
      <div class="dn-browser-body__pre">
        <pre class="is-not-compiled"><div class="dn-tag dn-tag--gray dn-tag--top dn-tag--button"><i class="fa fa-magic fa-lg"></i></div><div class="dn-tag dn-tag--gray dn-tag--bottom">.html</div><!--
          ...
          -->&lt;/div&gt;<!--
        --></pre>
        {% include not-reverse/is-compiled.html %}
      </div>
      {% include not-reverse/preview.html %}
      <div class="dn-browser-footer">
        <div class="wrap xl-gutter-24 xl-outside-24 xl-center xl-auto">
          <div class="col">
            <a href="http://codepen.io/dnomak/pen/QbYONd?editors=110" class="dn-button dn-button--link">
              http://codepen.io/dnomak/pen/QbYONd
            </a>
          </div>
        </div>
      </div>
