...
<div id="css">
  <div class="dn-browser">
    <div class="dn-browser-header">
      ...
      <div class="dn-style--title">wrap(align(<span>bottom</span>)) (css)</div>
    ...
    <div class="dn-browser-body">
      <div class="dn-browser-body__pre">
        ...
        <pre class="is-compiled"><div class="dn-tag dn-tag--black dn-tag--top dn-tag--button">close</div><!--
          --><span>wrap(align(bottom))</span><br/><!--
          -->  align-content: flex-end;<br/><!--
          -->  align-items: flex-end;<br/><!--
          --><span>wrap(align(bottom)) > col</span><br/><!--
          -->  vertical-align: bottom;<!--
        --></pre>
      </div>
      <div class="dn-browser-body__item">
        <div class="dn-tag dn-tag--red dn-tag--center">normal</div>
        <div class="wrap xl-bottom dn-style--wrap" style="height: 144px;">
      ...
      <div class="dn-browser-body__item">
        ...
        <div class="wrap xl-table xl-bottom dn-style--wrap" style="height: 144px;">
          <div class="col xl-3-12"><div class="dn-style--col">01</div></div>
          <div class="col xl-6-12"><div class="dn-style--col" style="height: 96px; line-height: 96px;">02</div></div>
          <div class="col xl-3-12"><div class="dn-style--col">03</div></div>
        </div>
      ...
      <div class="dn-browser-body__item">
        ...
        <div class="wrap xl-flexbox xl-bottom dn-style--wrap" style="height: 144px;">
          <div class="col xl-3-12"><div class="dn-style--col">01</div></div>
          <div class="col xl-6-12"><div class="dn-style--col" style="height: 96px; line-height: 96px;">02</div></div>
          <div class="col xl-3-12"><div class="dn-style--col">03</div></div>
        </div>
